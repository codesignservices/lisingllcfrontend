...
const servicesData = [
  {
    ...
    image: Calculator,
    content:
      "The State holds property that has not been claimed by the rightful owner. In some cases the property is only held for a certain period of time before the funds/property become the State's. We ensure diligent and accurate filing of our clients’ claims, streamlining the process.",
  },
  {
